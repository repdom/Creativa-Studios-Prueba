...
import {
  NzWaveDirective
} from "./chunk-A7X3XRZX.js";
import {
  NzTransitionPatchDirective
} from "./chunk-ZCUZCDCW.js";
import {
  NzI18nService
} from "./chunk-MLSYPQBY.js";
import {
  overlayZIndexSetter
...
import "./chunk-WRRIFI3M.js";
import "./chunk-SW2P5UQK.js";
import {
  animate,
  state,
  style,
  transition,
  trigger
} from "./chunk-55YYDBLK.js";
import {
  FocusTrapFactory,
  isFakeMousedownFromScreenReader,
  isFakeTouchstartFromScreenReader
} from "./chunk-JTTQ73U5.js";
import {
  ESCAPE,
  NzOutletModule,
...
var NzModalContainerComponent = class _NzModalContainerComponent extends BaseModalContainerComponent {
  ...
  static {
    this.ɵfac = function NzModalContainerComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzModalContainerComponent)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FocusTrapFactory), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(OverlayRef), ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(ModalOptions), ɵɵdirectiveInject(DOCUMENT, 8), ɵɵdirectiveInject(ANIMATION_MODULE_TYPE, 8));
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var NzModalService = class _NzModalService {
  ...
  static {
    this.ɵfac = function NzModalService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzModalService)(ɵɵinject(Overlay), ɵɵinject(Injector), ɵɵinject(NzConfigService), ɵɵinject(_NzModalService, 12), ɵɵinject(Directionality, 8));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
...
var NzModalFooterDirective = class _NzModalFooterDirective {
  ...
  static {
    this.ɵfac = function NzModalFooterDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzModalFooterDirective)(ɵɵdirectiveInject(NzModalRef, 8), ɵɵdirectiveInject(TemplateRef));
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
...
var NzModalTitleDirective = class _NzModalTitleDirective {
  ...
  static {
    this.ɵfac = function NzModalTitleDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzModalTitleDirective)(ɵɵdirectiveInject(NzModalRef, 8), ɵɵdirectiveInject(TemplateRef));
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
