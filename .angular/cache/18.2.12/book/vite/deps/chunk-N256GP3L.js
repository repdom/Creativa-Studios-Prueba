...
var NzSubmenuService = class _NzSubmenuService {
  ...
  static {
    this.ɵfac = function NzSubmenuService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzSubmenuService)(ɵɵinject(_NzSubmenuService, 12), ɵɵinject(MenuService), ɵɵinject(NzIsMenuInsideDropDownToken));
    };
  }
  static {
    this.ɵprov = ɵɵdefineInjectable({
...
var NzMenuItemComponent = class _NzMenuItemComponent {
  ...
  static {
    this.ɵfac = function NzMenuItemComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzMenuItemComponent)(ɵɵdirectiveInject(MenuService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NzSubmenuService, 8), ɵɵdirectiveInject(NzIsMenuInsideDropDownToken), ɵɵdirectiveInject(Directionality, 8), ɵɵdirectiveInject(RouterLink, 8), ɵɵdirectiveInject(Router, 8));
    };
  }
  static {
...
var NzSubmenuInlineChildComponent = class _NzSubmenuInlineChildComponent {
  ...
  static {
    this.ɵfac = function NzSubmenuInlineChildComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzSubmenuInlineChildComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(Directionality, 8));
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var NzSubmenuNoneInlineChildComponent = class _NzSubmenuNoneInlineChildComponent {
  ...
  static {
    this.ɵfac = function NzSubmenuNoneInlineChildComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzSubmenuNoneInlineChildComponent)(ɵɵdirectiveInject(Directionality, 8));
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var NzSubMenuTitleComponent = class _NzSubMenuTitleComponent {
  ...
  static {
    this.ɵfac = function NzSubMenuTitleComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzSubMenuTitleComponent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Directionality, 8));
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var NzSubMenuComponent = class _NzSubMenuComponent {
  ...
  static {
    this.ɵfac = function NzSubMenuComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzSubMenuComponent)(ɵɵdirectiveInject(MenuService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NzSubmenuService), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(NzIsMenuInsideDropDownToken), ɵɵdirectiveInject(Directionality, 8), ɵɵdirectiveInject(NzNoAnimationDirective, 9));
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
var NzMenuDirective = class _NzMenuDirective {
  ...
  static {
    this.ɵfac = function NzMenuDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzMenuDirective)(ɵɵdirectiveInject(MenuService), ɵɵdirectiveInject(NzIsMenuInsideDropDownToken), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Directionality, 8));
    };
  }
  static {
...
var NzMenuGroupComponent = class _NzMenuGroupComponent {
  ...
  static {
    this.ɵfac = function NzMenuGroupComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzMenuGroupComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NzIsMenuInsideDropDownToken));
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
...
//# sourceMappingURL=chunk-N256GP3L.js.map
